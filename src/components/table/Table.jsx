            ...
            {rows.map((row) => (
              <TableRow key={row.id}>
                <TableCell className="tableCell">
                  {row.isIncoming ? <div className='incoming'><CallReceivedIcon className="icon"/></div> :  <div className='outcoming'><CallMadeIcon className="icon"/></div>}
                </TableCell>
                ...
                <TableCell className="tableCell">{row.coint}</TableCell>
